...
import (
	...
	e "github.com/kurbanamankeldi-alt/movies-api/errors"
...
func (h *GenreHandler) Create(w http.ResponseWriter, r *http.Request) *e.HttpError {
	var genre entity.Genre
	err := json.NewDecoder(r.Body).Decode(&genre)
	if err != nil {
		return &e.HttpError{Err: err, Message: "invalid json", Code: http.StatusBadRequest}
	}
...
func (h *GenreHandler) GetAll(w http.ResponseWriter, r *http.Request) *e.HttpError {
...
func (h *GenreHandler) GetByID(w http.ResponseWriter, r *http.Request) *e.HttpError {
	idStr := r.PathValue("id")
	id, err := strconv.Atoi(idStr)
	if err != nil || id <= 0 {
		return &e.HttpError{Err: err, Message: "invalid id", Code: http.StatusBadRequest}
	}
...
func (h *GenreHandler) Update(w http.ResponseWriter, r *http.Request) *e.HttpError {
...
func (h *GenreHandler) Delete(w http.ResponseWriter, r *http.Request) *e.HttpError {
	idGenre := r.PathValue("id")
	id, err := strconv.Atoi(idGenre)
	if err != nil || id <= 0 {
		return &e.HttpError{Err: err, Message: "invalid id", Code: http.StatusBadRequest}
...
func (h *GenreHandler) DeleteConnection(w http.ResponseWriter, r *http.Request) *e.HttpError {
	idGenre := r.PathValue("id")
	id, err := strconv.Atoi(idGenre)
	if err != nil || id <= 0 {
		return &e.HttpError{Err: err, Message: "invalid id", Code: http.StatusBadRequest}
